      ...
      <div className="wrapper text-center text-primarytextcolor flex flex-col gap-7">
        ...
        <div className="flex flex-col gap-5">
          <h2 data-aos-offset={-200} data-aos="fade-up" className="heading-2">
            The Power Behind Our AI-Driven IT Solutions
          </h2>
          <p
            data-aos-offset={-200}
            data-aos="fade-up"
          ...
          >
            At Neuracodes, we are committed to providing AI-driven solutions
            tailored to your unique business needs. Our team is fueled by a
            passion for innovation and works closely with you to understand your
            vision, transforming it into a digital reality that goes beyond
            ...
            <div className="flex flex-col gap-5">
              ...
              >
                ...
                <p className="desc text-primarytextcolor text-start mt-3">
                  Neuracodes is a trusted IT company specializing in creating
                  innovative, customized solutions that are perfectly aligned
              ...
              >
                ...
                <p className="desc text-primarytextcolor text-start mt-3">
                  A forward-thinking approach centered on embracing change and
                  providing creative, flexible solutions that adapt to the
                  ever-evolving needs of your business.
                </p>
              </div>
            </div>
            <div
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 max-w-[60rem] ml-auto">
            ...
            <div className="flex flex-col gap-5 h-full">
              ...
              >
                ...
                <p className="desc text-primarytextcolor text-start mt-3">
                  Open, transparent, and collaborative communication to ensure
                  alignment and foster strong, lasting relationships.
                </p>
              </div>
              <div
                data-aos-offset={-200}
              ...
              >
                ...
                <p className="desc text-primarytextcolor text-start mt-3">
                  We prioritize robust security measures and strict adherence to
                  industry standards to protect your data, and
                  ensure compliance. Our approach includes encryption, regular
                  audits, and staying up-to-date with the latest regulations to
